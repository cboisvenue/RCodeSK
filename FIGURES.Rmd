...
## Figure 9. An example of the range of biomass increment curves for Balsam Poplar (BP) that can be extracted from the range of possible coefficient values fittes to the pixel-estimates of biomass increments.
```{r echo=FALSE,message=FALSE,warning=FALSE,fig.width=8, fig.height=5}
