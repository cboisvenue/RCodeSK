...
# Total time on A105345 with 30 threads:
####################################################################################################
...
writeRaster(leadSp_prop, "leadSp_prop.tif", format= "GTiff", datatype="FLT4S", , overwrite=TRUE)
writeRaster(leadSp_crop, "leadSp_layer_crop.tif", format= "GTiff", datatype="INT1U", overwrite=TRUE)
